...
export function ArtPhotosPage({ user, onBack, selectedGalleryId, selectedImageId }: ArtPhotosPageProps) {
  ...
  const handlePinGallery = async (galleryId: string) => {
    ...
    try {
      await galleryService.pinGallery(galleryId, user.uid, 'art');
      await loadGalleries();
  ...
  const handleShowcasePinGallery = async (galleryId: string) => {
    ...
    try {
      await galleryService.showcasePinGallery(galleryId, user.uid, 'art');
      await loadGalleries();
